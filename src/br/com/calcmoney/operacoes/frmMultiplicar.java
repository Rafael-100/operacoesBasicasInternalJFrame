...
public class frmMultiplicar extends JInternalFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					frmMultiplicar frame = new frmMultiplicar();
	...
	public String multiplicar(double val1, double val2) {
	...
	public frmMultiplicar() {
		...
		JLabel lblTitulo = new JLabel("x Multiplicar x");
		lblTitulo.setBounds(156, 11, 132, 24);
		lblTitulo.setFont(new Font("Arial", Font.BOLD, 20));
		
		JLabel lbSolicitacao = new JLabel("Digite os n\u00FAmeros que deseja multiplicar");
		lbSolicitacao.setBounds(90, 68, 264, 18);
		...
		JLabel lblOperacao = new JLabel("x");
		...
		btnCalcular.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				lblResult.setText(multiplicar(val1, val2));
			}
		});
