...
public class frmSubtrair extends JInternalFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					frmSubtrair frame = new frmSubtrair();
	...
	public String subtrair(double val1, double val2) {
	...
	public frmSubtrair() {
		...
		JLabel lblTitulo = new JLabel("- Subtrair -");
		lblTitulo.setBounds(168, 11, 108, 24);
		lblTitulo.setFont(new Font("Arial", Font.BOLD, 20));
		
		JLabel lbSolicitacao = new JLabel("Digite os n\u00FAmeros que deseja subtrair");
		lbSolicitacao.setBounds(98, 68, 247, 18);
		...
		btnCalcular.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				lblResult.setText(subtrair(val1, val2));
			}
		});
