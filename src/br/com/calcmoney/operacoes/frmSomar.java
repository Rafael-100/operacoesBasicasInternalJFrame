...
public class frmSomar extends JInternalFrame {
	...
	public String somar(double val1, double val2) {
	...
	public frmSomar() {
		...
		JLabel lblTitulo = new JLabel("+ Somar +");
		lblTitulo.setBounds(170, 11, 104, 24);
		lblTitulo.setFont(new Font("Arial", Font.BOLD, 20));
		
		JLabel lbSolicitacao = new JLabel("Digite os n\u00FAmeros que deseja somar");
		lbSolicitacao.setBounds(102, 68, 240, 18);
		...
		btnCalcular.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				lblResult.setText(somar(val1, val2));
			}
		});
